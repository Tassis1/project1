...
```
cd existing_repo
git remote add origin https://gitlab.com/mechdaltahar1/gitlab.project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mechdaltahar1/gitlab.project/-/settings/integrations)
